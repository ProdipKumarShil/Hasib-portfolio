...
const RecentWork = () => {
  return (
    <div className='mb-20'>
      ...
      <div className="max-w-screen-xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-[30px] justify-items-center">
        <WorkCard />
        <WorkCard />
      </div>
    </div>
...
const WorkCard = () => {
  return (
    <div className=" max-w-[445px]">
      <img className="h-[300px] object-cover w-full rounded mb-10" src="https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="" />
